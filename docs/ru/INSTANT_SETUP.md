...
6. Держи markdown как source of truth, а indexes как rebuildable caches.
7. Не публикуй private vault, logs, traces, generated indexes и secrets.
8. Не называй систему battle-ready, пока не пройдены doctor, health, preflight и finalize, а clean clone не проходит parity-check.
