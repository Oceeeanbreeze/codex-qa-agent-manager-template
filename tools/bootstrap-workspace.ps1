...
$dirs = @(
    ...
    (Join-Path $VaultDir 'Agents\Archivist'),
    (Join-Path $VaultDir 'Agents\Router'),
    (Join-Path $VaultDir 'Agents\Researcher'),
    (Join-Path $VaultDir 'Agents\Architect'),
    (Join-Path $VaultDir 'Agents\Implementer'),
    (Join-Path $VaultDir 'Agents\Reviewer'),
    (Join-Path $VaultDir 'Agents\Tester'),
    (Join-Path $VaultDir 'Agents\Test-Strategist'),
    (Join-Path $VaultDir 'Agents\Test-Automation-Engineer'),
    (Join-Path $VaultDir 'Agents\QA-Browser'),
